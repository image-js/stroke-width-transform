...
EMSCRIPTEN_BINDINGS(ccv_js_module) {
  ...
  value_object<ccv_swt_param_t>("ccv_swt_param_t")
    ...
    .field("minNeighbors", &ccv_swt_param_t::min_neighbors)
    .field("scaleInvariant", &ccv_swt_param_t::scale_invariant)
    .field("direction", &ccv_swt_param_t::direction)
    .field("sameWordThresh", reinterpret_cast<std::array<double, 2> ccv_swt_param_t::*>(&ccv_swt_param_t::same_word_thresh)) // Emscripten doesn't like the type double[2], https://github.com/kripken/emscripten/pull/4510
    .field("size", &ccv_swt_param_t::size)
    .field("lowThresh", &ccv_swt_param_t::low_thresh)
    .field("highThresh", &ccv_swt_param_t::high_thresh)
    .field("maxHeight", &ccv_swt_param_t::max_height)
    .field("minHeight", &ccv_swt_param_t::min_height)
    .field("minArea", &ccv_swt_param_t::min_area)
    .field("letterOccludeThresh", &ccv_swt_param_t::letter_occlude_thresh)
    .field("aspectRatio", &ccv_swt_param_t::aspect_ratio)
    .field("stdRatio", &ccv_swt_param_t::std_ratio)
    .field("thicknessRatio", &ccv_swt_param_t::thickness_ratio)
    .field("heightRatio", &ccv_swt_param_t::height_ratio)
    .field("intensityThresh", &ccv_swt_param_t::intensity_thresh)
    .field("distanceRatio", &ccv_swt_param_t::distance_ratio)
    .field("intersectRatio", &ccv_swt_param_t::intersect_ratio)
    .field("elongateRatio", &ccv_swt_param_t::elongate_ratio)
    .field("letterThresh", &ccv_swt_param_t::letter_thresh)
    .field("breakdown", &ccv_swt_param_t::breakdown)
    .field("breakdownRatio", &ccv_swt_param_t::breakdown_ratio);
}
